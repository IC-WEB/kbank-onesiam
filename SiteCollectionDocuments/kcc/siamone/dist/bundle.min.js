...
$(function () {
  if ($('.accordion-revise').length) {
    let accRewise = $('.accordion-revise'),
        title = $(accRewise).find('>.accordion-title-revise:not(".accordion-popup-title")'),
        content = $(accRewise).find('>.accordion-content:not(".accordion-popup-content")'),
        popupTitle = $(accRewise).find('>.accordion-title-revise.accordion-popup-title'),
        popupContent = $(accRewise).find('>.accordion-content.accordion-popup-content');
    ...
    title.click(function (ele) {
      ele.preventDefault();
      console.log(`popup title default click : Class Name  ${title.attr('class')}`);
...
$(document).ready(function ($) {
  ...
  try {
    ...
    $('.sc-special .cardTab__item').on('click', function (e) {
      ...
      $('.sc-special .cardTitle-' + $(this).attr('id')).addClass('cardTitle--active');
  ...
  $('.toggle-popup').magnificPopup({
    ...
    callbacks: {
      open: function () {
        console.log('Open magnificPopup'); // Will fire when this exact popup is opened
        // this - is Magnific Popup object

        $(window).trigger('link-scroll-ready');
        $.each($('.compn-overflow-revise'), function () {
          var width = $(this).find('.compn-overflow-wrapper-revise').width() * $(this).find('.compn-overflow-wrapper-revise').width() / $(this).find('.compn-revise').width();
          console.log(width);
          $(this).find('.compn-overflow-scroll-revise').css('width', width + 'px');
          $(this).find('.compn-overflow-wrapper-revise').scroll(function () {
            width = $(this).width() * $(this).width() / $(this).find('.compn-revise').width();
            $(this).parent().find('.compn-overflow-scroll-revise').css('width', width + 'px');
            $(this).parent().find('.compn-overflow-scroll-revise').css('margin-left', $(this).scrollLeft() / $(this).parent().find('.compn-revise').width() * $(this).width() + 'px');
          });
        });
      },
      resize: function () {
  ...
  setTimeout(function () {
    $('.sc-bottom-bars .bottom-bars .list:last-child a').prop('href', 'tel:+6628888888');
  }, 2000); // uat shortcutnav
