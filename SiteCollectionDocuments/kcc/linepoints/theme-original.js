...
$(function() {
    if ($(".accordion").length) {
        $(".accordion").each(function() {
            var acc = $(this),
                popupTitle = $(this).find(">.accordion-popup-title"),
                popupContent = $(this).find(">.accordion-popup-content"),
        ...
        $(window).on('load resize', function(){
            var acc = $(".accordion"),
                popupTitle = $(acc).find(">.accordion-popup-title"),
                popupContent = $(acc).find(">.accordion-popup-content")

            var win = $(this); //this = window
            if( popupTitle.length && popupContent.length ) {
                if (win.width() <= 767) { 
                    popupTitle.removeClass('active');
                    popupTitle.bind('click');
                    popupContent.css('display', 'none');
                    
                } else {
                    popupTitle.addClass('active');
                    popupTitle.unbind("click");
    ...
    if ($(".benefit-more").length) {
        $( ".benefit-more" ).click(function() {
            ...
            if(BenefitMore.hasClass("expand")){
               BenefitMore.html('à¸¢à¹ˆà¸­à¸ªà¸´à¸—à¸˜à¸´à¸›à¸£à¸°à¹‚à¸¢à¸Šà¸™à¹Œ <i class="ic ic-chevron-up"></i>');
            }else {
                BenefitMore.html('à¸”à¸¹à¸ªà¸´à¸—à¸˜à¸´à¸›à¸£à¸°à¹‚à¸¢à¸Šà¸™à¹Œà¹€à¸žà¸´à¹ˆà¸¡à¹€à¸•à¸´à¸¡ <i class="ic ic-chevron-down"></i>');
            }
        });
    }
});
    ...
    if ($(".all-card-more").length) {
        $( ".all-card-more" ).click(function() {
            ...
            if(AllCardMore.hasClass("expand")){
               AllCardMore.html('à¸¢à¹ˆà¸­à¸šà¸±à¸•à¸£à¸—à¸±à¹‰à¸‡à¸«à¸¡à¸” <i class="ic ic-chevron-up"></i>');
            }else {
                AllCardMore.html('à¸”à¸¹à¸šà¸±à¸•à¸£à¹€à¸žà¸´à¹ˆà¸¡à¹€à¸•à¸´à¸¡ <i class="ic ic-chevron-down"></i>');
            }
        });
    }
});
...
/* Application Details */
$(function () {
    $('<div class="tab-headline qualifications"><h2 class="heading">à¸„à¸¸à¸“à¸ªà¸¡à¸šà¸±à¸•à¸´</h2></div>').prependTo('.tab-container').hide();
    $('<div class="tab-headline documents"><h2 class="heading">à¹€à¸­à¸à¸ªà¸²à¸£à¸›à¸£à¸°à¸à¸­à¸šà¸à¸²à¸£à¸ªà¸¡à¸±à¸„à¸£</h2></div>').prependTo('.tab-container').hide();
